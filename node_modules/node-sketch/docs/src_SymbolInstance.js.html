...
<head>
    ...
    <meta charset="utf-8">
    <title>src/SymbolInstance.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">src/SymbolInstance.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const _symbol = Symbol.for('symbolMaster');
